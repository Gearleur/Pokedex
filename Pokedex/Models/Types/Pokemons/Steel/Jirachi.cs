// https://www.pokemon.com/us/pokedex/385
...
{
    internal class Jirachi : Pokemon
    {
        #region Variables
        ...
        {
            get { return _instance ?? (_instance = new Jirachi()); }
        }
        #endregion
        ...
        private Jirachi()
            : base(
                ...
                "On raconte que lorsqu’il se réveille de son sommeil millénaire, il exauce les vœux écrits sur les rubans de papier de sa tête.",
                100,
                100,
                100,
                100,
        ...
        public override void InitMoveList()
        {
            ...
            this._moveList.Add(DoomDesire.Instance);
